...
describe('test validation', () => {
  ...
  it('should cascade children errors to parents', () => {
    ...
    expect(validation.children!.form.children!.cat1.children!.val2.$errors).to.eql(['form.cat1.val2[EQ_ERROR]']);
    ...
    expect(validation.children!.form.children!.cat1.$errors).to.eql(['form.cat1.val2[EQ_ERROR]']);
    ...
    expect(validation.children!.form.children!.cat2.children!.val3.$errors).to.eql(['form.cat2.val3[EQ_ERROR]']);
    ...
    expect(validation.children!.form.children!.cat2.children!.val4.$errors).to.eql(['form.cat2.val4[EQ_ERROR]']);
    ...
    expect(validation.children!.form.children!.cat2.$errors).to.eql(['form.cat2.val3[EQ_ERROR]', 'form.cat2.val4[EQ_ERROR]']);
    ...
    expect(validation.children!.form.$errors).to.eql(['form.cat1.val2[EQ_ERROR]', 'form.cat2.val3[EQ_ERROR]', 'form.cat2.val4[EQ_ERROR]']);
    ...
    expect(validation.$errors).to.eql(['form.cat1.val2[EQ_ERROR]', 'form.cat2.val3[EQ_ERROR]', 'form.cat2.val4[EQ_ERROR]']);
  ...
  it('should build context', () => {
    ...
    const context = validation.children!.form.children!.cat1.children!.val1.getContext()

    assert.isDefined(context)
    expect(context.component).is.equal(component);
    expect(context.path).is.equal('form.cat1.val1');
    expect(context.value).is.equal(1)
    expect(context.parent).is.deep.equal(validation.children!.form.children!.cat1.getContext());
    expect(context.parent.value).is.eql({ val1: 1, val2: 0 })
  })
